...
{home_judgement_html}
<section class="daily-card home-close-card"><div class="daily-section-title"><h2>📘 收盤摘要</h2><span>收盤後整理</span></div><p>完整正／負貢獻與收盤後結果集中在下方展開查看，避免首頁資訊重複堆疊。</p><a href="#home-contribution">查看完整歸因明細 →</a></section>
<details class="home-detail-collapse" id="home-contribution"><summary>展開完整正／負貢獻明細</summary>{contribution_html}</details>
